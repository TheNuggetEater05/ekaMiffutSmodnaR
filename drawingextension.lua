--[[ 
Made by Zinzox, 
Edited by Syntax Err04/Jaydenn
]]
if not getgenv().drawingextension then
    getgenv().drawingextension = true

    local Signal = loadstring(game:HttpGet("https://raw.githubusercontent.com/Quenty/NevermoreEngine/main/src/signal/src/Shared/Signal.lua"))()
